...
export const SEO_LOCATIONS: SeoLocationPage[] = [
  {
    ...
    metaDescription:
      "NPT Logistics provides truckload, LTL, intermodal, and cross-border freight shipping in Milton, Ontario with lane-level execution across North America.",
    intro:
  ...
  },
  {
    ...
    serviceHighlights: [
      ...
      "Intermodal alternatives for cost-sensitive long-haul lanes",
    ],
    topLanes: [
  ...
  },
  {
    ...
    serviceHighlights: [
      "FTL, LTL, and intermodal support for Texas distribution",
      "Cross-border freight planning to and from Mexico",
      "Temperature-controlled freight support for sensitive cargo",
    ],
    topLanes: [
      { label: "Houston, TX to Milton, ON freight", href: "/lanes/houston-tx-to-milton-on" },
  ...
  },
  {
    ...
    metaDescription:
      "Freight transportation from Dallas, Texas with truckload, LTL, intermodal, and cross-border logistics support.",
    intro:
    ...
    topLanes: [
      ...
      { label: "Dallas, TX to Milton, ON freight", href: "/lanes/dallas-tx-to-milton-on" },
  ...
  },
  {
    ...
    serviceHighlights: [
      ...
      "Intermodal support for selected long-haul corridors",
    ],
    topLanes: [
  ...
  },
  {
    ...
    serviceHighlights: [
      "West-coast outbound truckload and intermodal freight planning",
