    ...
    <main className="bg-[color:var(--color-surface-0-light)] py-14 sm:py-16">
      <Container className="max-w-4xl px-4 sm:px-6">
        <div className="rounded-2xl border border-[color:var(--color-border-light)] bg-white p-6 shadow-[0_12px_32px_rgba(2,6,23,0.08)] sm:p-8">
          <h1 className="text-3xl font-semibold text-[color:var(--color-text-light)]">Terms of Service</h1>
          ...
          <p className="mt-4 text-sm leading-relaxed text-[color:var(--color-muted-light)] sm:text-base">
            These Terms of Service govern your use of the NPT Logistics website. By accessing or using
            this website, you agree to these terms and applicable laws.
          </p>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-[color:var(--color-muted-light)] sm:text-base">
            ...
            <li>Do not attempt unauthorized access, disruption, scraping, or misuse of site content.</li>
            <li>
              Information submitted through forms must be accurate and submitted with proper authority.
            </li>
          </ul>
          ...
          <p className="mt-3 text-sm leading-relaxed text-[color:var(--color-muted-light)] sm:text-base">
            ...
            pricing, liabilities, transit commitments, and operating obligations are defined in signed
            customer agreements, rate confirmations, and related operational documents.
          </p>
          ...
          <p className="mt-3 text-sm leading-relaxed text-[color:var(--color-muted-light)] sm:text-base">
            ...
            with permission. Reproduction, republication, or distribution without prior written consent
            is prohibited.
          </p>
          ...
          <p className="mt-3 text-sm leading-relaxed text-[color:var(--color-muted-light)] sm:text-base">
            ...
            losses arising from website use. Nothing in these terms limits liabilities that cannot be
          ...
          <p className="mt-3 text-sm leading-relaxed text-[color:var(--color-muted-light)] sm:text-base">
            These terms are governed by applicable laws in relevant jurisdictions where NPT Logistics
            operates. We may update these terms periodically by posting revised versions on this page.
          </p>

          <h2 className="mt-8 text-xl font-semibold text-[color:var(--color-text-light)]">Contact</h2>
          <p className="mt-3 text-sm leading-relaxed text-[color:var(--color-muted-light)] sm:text-base">
