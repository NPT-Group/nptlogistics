    ...
    <main className="bg-[color:var(--color-surface-0-light)] py-14 sm:py-16">
      <Container className="max-w-4xl px-4 sm:px-6">
        <div className="rounded-2xl border border-[color:var(--color-border-light)] bg-white p-6 shadow-[0_12px_32px_rgba(2,6,23,0.08)] sm:p-8">
          <h1 className="text-3xl font-semibold text-[color:var(--color-text-light)]">Cookie Policy</h1>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-[color:var(--color-muted-light)] sm:text-base">
            <li>
              <strong>Strictly necessary cookies:</strong> required for core site operation, security,
              and consent preference storage.
            </li>
            <li>
              <strong>Analytics cookies:</strong> used with consent to measure page engagement and CTA
              performance (for example, page views and CTA clicks).
            </li>
          </ul>
          ...
          <p className="mt-3 text-sm leading-relaxed text-[color:var(--color-muted-light)] sm:text-base">
            ...
            . Essential cookies cannot be disabled because they are required for secure site operation.
          </p>
          ...
          <p className="mt-3 text-sm leading-relaxed text-[color:var(--color-muted-light)] sm:text-base">
            Where enabled by your consent, analytics features may rely on third-party providers such as
            Google Analytics to generate aggregated performance insights.
          </p>
